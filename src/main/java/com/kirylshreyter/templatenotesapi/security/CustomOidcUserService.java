...
public class CustomOidcUserService extends OidcUserService {
    private static final Logger LOGGER = LoggerFactory.getLogger(OAuth2LoginSecurityConfig.class);
    ...
    private OidcUser processOidcUser(OidcUserRequest userRequest, OidcUser oidcUser) {
        ...
        User user = conversionService.convert(googleUserInfo, User.class);
